...
<a target="_blank" href="../images/input-simulation/MRTK_InputAnimation_PlaybackDiagram.png"> <img src = ".. /images/input-Simulation/MRTK_InputAnimation_PlaybackDiagram.png "title =" riproduzione dell'animazione di input "width =" 80% "Alt =" diagramma di riproduzione animazione "class =" Center "/> </a>
