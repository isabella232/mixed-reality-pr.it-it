...
* Vedere la [luce del passaggio del mouse](rendering/HoverLight.md)

### <a name="proximity-light"></a>Luce vicina

* Vedere la [luce vicina](rendering/ProximityLight.md)
...
* Vedere [primitiva di ritaglio](Rendering/ClippingPrimitive.md)
...
![estrusione di vertici](images/mrtk-standard-shader/MRTK_VertexExtrusion.gif)
...
* [Luce al passaggio del mouse](rendering/HoverLight.md)
* [Luce vicina](rendering/ProximityLight.md)
