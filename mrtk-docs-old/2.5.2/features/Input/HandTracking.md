...
Per impostazione predefinita, i prefabbricati di join sono semplici primitive geometriche. Se lo si desidera, è possibile sostituirli. Se non viene specificata alcuna prefabbricata, vengono invece creati [GameObject](https://docs.unity3d.com/ScriptReference/GameObject.html) vuoti.
...
<img src = ".. /images/input-Simulation/MRTK_Core_Input_Hands_ArticulatedHandMesh.png "width =" 350px "Style =" display: Block; " Alt = "visualizzazione Mesh a mano articolata" >
