...
1. Verificare che il puntatore pertinente sia registrato nel [profilo di configurazione](../../configuration/MixedRealityConfigurationGuide.md)principale di MRTK.
...
> ![Esempio di Gizmo NearInteractionTouchable 2](../images/input/pointers/NearInteractionTouchableGizmos.png)
