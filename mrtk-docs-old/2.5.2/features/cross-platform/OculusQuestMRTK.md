...
1. Passare al Toolkit di realtà mista > Oculus > moduli di integrazione di Oculus di OculusSeparationAsmdefView separati. ![](../images/cross-platform/oculus-quest/OculusSeparationAsmdef.png)
