...
1. Qualsiasi documentazione relativa a una funzionalità sperimentale dovrebbe andare in un `README.md` file nella cartella sperimentale. ad esempio [`MRTK/SDK/Experimental/PulseShader/README.md`](../features/Experimental/PulseShader/README.md).
