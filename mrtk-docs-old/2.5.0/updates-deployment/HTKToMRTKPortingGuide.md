...
| Configurazione                     | Posizionare il InputManager nella scena. | Abilitare il sistema di input nel [profilo di configurazione](../out-of-scope/MixedRealityConfigurationGuide.md) e specificare un tipo di sistema di input concreto. |
...
| Configurazione             | Le parole chiave riconosciute vengono configurate nel controllo di SpeechInputSource. | Le parole chiave sono configurate nel [profilo dei comandi vocali di realtà mista](Input/Speech.md). |
...
|           Metodi                | HTK 2017 |  MRTK V2  |
|---------------------------|----------|-----------|
| Pulsante                     | [Oggetti interagibili](https://github.com/Microsoft/MixedRealityToolkit-Unity/blob/htk_release/Assets/HoloToolkit-Examples/UX/Readme/README_InteractableObjectExample.md) | [Button](../features/README_Button.md) |
| Con cui                     | [Oggetti interagibili](https://github.com/Microsoft/MixedRealityToolkit-Unity/blob/htk_release/Assets/HoloToolkit-Examples/UX/Readme/README_InteractableObjectExample.md) | [Con cui](../features/README_Interactable.md) |
| Riquadro             | [Rettangolo di delimitazione](https://github.com/Microsoft/MixedRealityToolkit-Unity/blob/htk_release/Assets/HoloToolkit-Examples/UX/Readme/README_BoundingBoxGizmoExample.md) | [Rettangolo di delimitazione](../features/README_BoundingBox.md) |
| Barra dell'app             | [Barra dell'app](https://github.com/Microsoft/MixedRealityToolkit-Unity/blob/htk_release/Assets/HoloToolkit-Examples/UX/Readme/README_BoundingBoxGizmoExample.md) | [Barra dell'app](../features/README_AppBar.md) |
| Manipolazione a mano singola (GRB e Move)   | [HandDraggable](https://github.com/Microsoft/MixedRealityToolkit-Unity/blob/htk_release/Assets/HoloToolkit/Input/Scripts/Utilities/Interactions/HandDraggable.cs) | [Gestore di manipolazione](../features/README_ManipulationHandler.md) |
| Manipolazione a due mani (recupero/spostamento/rotazione/scala)             | [TwoHandManipulatable](https://github.com/Microsoft/MixedRealityToolkit-Unity/blob/htk_release/Assets/HoloToolkit/Input/Scripts/Utilities/Interactions/TwoHandManipulatable.cs) | [Gestore di manipolazione](../features/README_ManipulationHandler.md) |
| Tastiera             | [Prefabbricato tastiera]() | [Tastiera di sistema](../features/README_SystemKeyboard.md) |
| Descrizione comando             | [Descrizione comando](https://github.com/Microsoft/MixedRealityToolkit-Unity/blob/htk_release/Assets/HoloToolkit-Examples/UX/Readme/README_TooltipExample.md) | [Descrizione comando](../features/README_Tooltip.md) |
| Raccolta di oggetti             | [Raccolta di oggetti](https://github.com/Microsoft/MixedRealityToolkit-Unity/blob/htk_release/Assets/HoloToolkit-Examples/UX/Readme/README_ObjectCollection.md) | [Raccolta di oggetti](../features/README_ObjectCollection.md) |
...
| Tagalong | [`RadialView`](xref:Microsoft.MixedReality.Toolkit.Utilities.Solvers.RadialView) o [`Orbital`](xref:Microsoft.MixedReality.Toolkit.Utilities.Solvers.Orbital) [Risolutore](../features/README_Solver.md) |
| FixedAngularSize | [`ConstantViewSize`](xref:Microsoft.MixedReality.Toolkit.Utilities.Solvers.ConstantViewSize)[Risolutore](../features/README_Solver.md) |
| FpsDisplay | [Sistema di diagnostica](../features/Diagnostics/DiagnosticsSystemGettingStarted.md) (nel profilo di configurazione) |
| NearFade | Shader incorporato a [mixed reality Toolkit standard](../features/README_MRTKStandardShader.md) |
