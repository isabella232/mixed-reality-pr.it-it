...
> [!Note]
> Per lo sviluppo di Android e iOS sono necessarie installazioni aggiuntive per i pacchetti. Per ulteriori informazioni, vedere [come configurare MRTK per iOS e Android](features/CrossPlatform/UsingARFoundation.md).
