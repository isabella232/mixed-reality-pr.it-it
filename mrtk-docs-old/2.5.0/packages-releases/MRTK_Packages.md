...
| --- | --- | --- |
| MRTK/estensioni | |
| | [HandPhysicsService](../features/Extensions/HandPhysicsService/HandPhysicsServiceOverview.md) | Servizio che aggiunge il supporto per la fisica a mani articolate. |
...
| | [Casella degli strumenti](../features/README_Toolbox.md) | Interfaccia utente che semplifica l'individuazione e l'utilizzo dei componenti UX MRTK. |
