...
1. Verificare che il puntatore pertinente sia registrato nel [profilo di configurazione](../../out-of-scope/MixedRealityConfigurationGuide.md)principale di MRTK.
...
> ![Esempio di Gizmo NearInteractionTouchable](../Images/Input/Pointers/NearInteractionTouchableGizmos.png)
