...
Questo articolo illustra come configurare e rispondere all'input del puntatore in pratica rispetto all' [architettura del puntatore](../../architecture/ControllersPointersAndFocus.md)
...
- [Architettura del puntatore](../../architecture/ControllersPointersAndFocus.md)
