...
> [!IMPORTANT]
> Per il corretto funzionamento dell'effetto di ritaglio nell'area visualizzabile, qualsiasi materiale oggetto contenuto scorrevole deve usare lo [shader standard MRTK](../rendering/MRTK-standard-shader.md) .
...
* [Shader standard](../rendering/MRTK-standard-shader.md)
