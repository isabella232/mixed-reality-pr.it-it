...
![Oggetto Risolutore rilevabile](Images/Solver/TrackedObjectType-Example.gif)  
...
Per esempi relativi all'uso del Risolutore di vincoli di mano, [vedere la pagina del menu](README_HandMenu.md) a mano per creare menu a mano.
