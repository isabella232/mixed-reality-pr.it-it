...
> [!IMPORTANT]
> DefaultHoloLens2ConfigurationProfile è ottimizzato per HoloLens 2. Per informazioni dettagliate, vedere [profili](Profiles/Profiles.md) .
...
Situato nella pagina di configurazione principale del Toolkit di realtà mista, questa impostazione definisce l'operazione predefinita della [scala dell'ambiente di realtà mista](https://docs.microsoft.com/en-us/windows/mixed-reality/coordinate-systems-in-unity) per il progetto.
...
![Utilità del buffer di profondità ](../features/Images/MixedRealityToolkitConfigurationProfileScreens/MRTK_DepthBufferExample.gif)
