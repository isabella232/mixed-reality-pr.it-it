...
* Controllare la compatibilità della scheda grafica e del driver:
    ...
    * Se il PC dispone di un'unità di elaborazione grafica integrata (iGPU) e di un'unità di elaborazione grafica discreta (dGPU), assicurarsi di essere connessi alla porta HDMI di dGPU.
...
## <a name="my-headset-displays-turn-blue-and-then-mixed-reality-portal-re-initializes"></a>L'auricolare diventa blu e il portale per realtà mista Reinizializza nuovamente
...
## <a name="my-headset-displays-are-very-choppy-but-mixed-reality-portals-preview-window-appears-fine"></a>I display dell'auricolare sono molto frammentati, ma la finestra di anteprima del portale di realtà mista sembra corretta
