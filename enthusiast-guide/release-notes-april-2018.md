...
* È **necessario ripetere la sincronizzazione dei certificati Wi-Fi aziendali** . si sta esaminando un problema che richiede che il HoloLens sia connesso a una rete diversa affinché i certificati aziendali vengano nuovamente sincronizzati con il dispositivo prima che sia in grado di riconnettersi alle reti aziendali usando i certificati. 
