...
Il primo passaggio consiste nel puntare lo  strumento di  funzionalità di realtà mista al percorso del progetto usando il pulsante con i puntini di sospensione, fare clic sul pulsante con i puntini di sospensione tre puntini di sospensione accanto al percorso del progetto e passare alla cartella del progetto nello strumento di esplorazione, ad esempio _D:\MixedRealityLearning\MRTK Tutorials_.
...
Fare quindi clic su **Start per** iniziare a usare Mixed Reality Feature Tool.
...
Fare clic **su Avanti** e quindi **fare** clic sul pulsante Fine nella finestra di MRTK Project Configurator per completare la configurazione del progetto Unity per Legecy XR.
