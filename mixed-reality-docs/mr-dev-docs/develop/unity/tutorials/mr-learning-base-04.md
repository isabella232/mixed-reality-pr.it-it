...
Nel pacchetto di importazione... Selezionare il **MRTK. HoloLens2. Unity. Tutorials. assets. GettingStarted. 2.4.0. file unitypackage Tools** è stato scaricato e si fa clic sul pulsante Apri:
