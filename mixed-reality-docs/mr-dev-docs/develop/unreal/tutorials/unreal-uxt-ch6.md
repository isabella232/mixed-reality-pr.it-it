...
2.  Nell'editor Unreal passare  a Modifica > Project Impostazioni e  selezionare Abilita comunicazione remota nella **sezione Open XR Holographic Remoting (Open XR Holographic Remoting).**
