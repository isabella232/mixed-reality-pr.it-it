...
## <a name="device-support"></a><span data-ttu-id="2e5b5-112">Supporto di dispositivi</span><span class="sxs-lookup"><span data-stu-id="2e5b5-112">Device support</span></span>
