...
* Fattori esterni che inibiscono il tracciamento oculare affidabile, ad esempio sbavature sulla visiera HoloLens o occhiali da vista, intensa luce solare diretta e occlusioni a causa dei peli davanti agli occhi
...
Per informazioni più dettagliate su come accedere ai dati di tracciamento oculare, vedere le guide per gli sviluppatori per l'uso dello sguardo fisso [in DirectX](../develop/native/gaze-in-directx.md) e dello sguardo [fisso in Unity.](https://aka.ms/mrtk-eyes)
...
-   **Valutazioni della progettazione, marketing e ricerca dei consumatori:** Il tracciamento oculare consente alle aziende commerciali di eseguire studi di marketing e consumer in ambienti reali o di analizzare ciò che acquisisce l'attenzione dell'utente per migliorare la progettazione di prodotti o spazi. 

### <a name="other-use-cases"></a>Altri casi d'uso

- **Giochi:** Si è mai desiderato avere superpoteri? Ora hai questa opportunità. È possibile le lessare gli ologrammi fissandoli. Indossereranno i raggi dagli occhi: è possibile provarlo in [RoboRaid per HoloLens 2](https://www.microsoft.com/p/roboraid/9nblggh5fv3j).
...
Questa pagina ha fornito una buona panoramica per iniziare a comprendere il ruolo del tracciamento oculare e dell'input dello sguardo fisso per HoloLens 2. Per iniziare a sviluppare, vedere le informazioni sul ruolo dello sguardo fisso per interagire con [ologrammi,](eye-gaze-interaction.md)sguardo fisso [in Unity](https://aka.ms/mrtk-eyes) e sguardo fisso [in DirectX.](../develop/native/gaze-in-directx.md)
