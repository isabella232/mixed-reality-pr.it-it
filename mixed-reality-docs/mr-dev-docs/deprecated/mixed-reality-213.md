...
* <span data-ttu-id="f3bf5-167">Sono disponibili due scene Unity completate nella cartella **Scenes** .</span><span class="sxs-lookup"><span data-stu-id="f3bf5-167">You will find two completed Unity scenes under **Scenes** folder.</span></span>
...
* <span data-ttu-id="f3bf5-184">Fare clic su **finestra > illuminazione impostazioni >**</span><span class="sxs-lookup"><span data-stu-id="f3bf5-184">Click **Window > Lighting > Settings**</span></span>
...
* <span data-ttu-id="f3bf5-199">Impostazione predefinita: utilizzo del controller predefinito senza modifiche</span><span class="sxs-lookup"><span data-stu-id="f3bf5-199">Default - Using default controller without modification</span></span>
...
<span data-ttu-id="f3bf5-215">**Script MotionControllerVisualizer**</span><span class="sxs-lookup"><span data-stu-id="f3bf5-215">**MotionControllerVisualizer script**</span></span>
...
* <span data-ttu-id="f3bf5-225">**Salva** la scena e fai clic sul pulsante **Riproduci** .</span><span class="sxs-lookup"><span data-stu-id="f3bf5-225">**Save** the scene and click the **play** button.</span></span>
...
<span data-ttu-id="f3bf5-238">**Script MotionControllerInfo**</span><span class="sxs-lookup"><span data-stu-id="f3bf5-238">**MotionControllerInfo script**</span></span>
...
* <span data-ttu-id="f3bf5-285">Nel pannello **gerarchia** fare clic su **ColorPickerWheel**</span><span class="sxs-lookup"><span data-stu-id="f3bf5-285">In the **Hierarchy** panel, click **ColorPickerWheel**</span></span>
...
<span data-ttu-id="f3bf5-301">Se entrambi sono true, la posizione del touchpad (obj. state.**touchpadPosition**) viene assegnato a **selectorPosition**.</span><span class="sxs-lookup"><span data-stu-id="f3bf5-301">If both are true, the touchpad position (obj.state.**touchpadPosition**) is assigned to **selectorPosition**.</span></span>
...
<span data-ttu-id="f3bf5-333">**Script BrushController**</span><span class="sxs-lookup"><span data-stu-id="f3bf5-333">**BrushController script**</span></span>
...
<span data-ttu-id="f3bf5-360">Per un evento di **comprensione** , incrementa l'indice del tipo di mesh corrente (Sphere, Cube, Cylinder)</span><span class="sxs-lookup"><span data-stu-id="f3bf5-360">For a **Grasp** event, it increments the index of current mesh type (sphere, cube, cylinder)</span></span>
...
<span data-ttu-id="f3bf5-413">**BrushSelector** utilizza due utilità:</span><span class="sxs-lookup"><span data-stu-id="f3bf5-413">The **BrushSelector** makes use of two utilities:</span></span>
...
<span data-ttu-id="f3bf5-436">**Selezione dello strumento pennello con input touchpad**</span><span class="sxs-lookup"><span data-stu-id="f3bf5-436">**Brush tool selection with touchpad input**</span></span>
...
<span data-ttu-id="f3bf5-441">**Script di gomma**</span><span class="sxs-lookup"><span data-stu-id="f3bf5-441">**Eraser script**</span></span>
...
## <a name="advanced-design---teleportation-and-locomotion"></a><span data-ttu-id="f3bf5-445">Progettazione avanzata: teleporte e locomozione</span><span class="sxs-lookup"><span data-stu-id="f3bf5-445">Advanced design - Teleportation and locomotion</span></span>

<span data-ttu-id="f3bf5-446">Se si vuole consentire all'utente di spostarsi nella scena con la teleportazione con levetta, usare **MixedRealityCameraParent** anziché **MixedRealityCamera**.</span><span class="sxs-lookup"><span data-stu-id="f3bf5-446">If you want to allow the user to move around the scene with teleportation using thumbstick, use **MixedRealityCameraParent** instead of **MixedRealityCamera**.</span></span> <span data-ttu-id="f3bf5-447">È anche necessario aggiungere **InputManager** e **DefaultCursor**.</span><span class="sxs-lookup"><span data-stu-id="f3bf5-447">You also need to add **InputManager** and **DefaultCursor**.</span></span> <span data-ttu-id="f3bf5-448">Poiché **MixedRealityCameraParent** include già **MotionControllers** e **Boundary** come componenti figlio, è necessario rimuovere i prefabbricati **MotionControllers** e **Environment** esistenti.</span><span class="sxs-lookup"><span data-stu-id="f3bf5-448">Since **MixedRealityCameraParent** already includes **MotionControllers** and **Boundary** as child components, you should remove existing **MotionControllers** and **Environment** prefab.</span></span>

### <a name="instructions"></a><span data-ttu-id="f3bf5-449">Istruzioni</span><span class="sxs-lookup"><span data-stu-id="f3bf5-449">Instructions</span></span>

* <span data-ttu-id="f3bf5-450">Nel pannello **gerarchia** eliminare **MixedRealityCamera**, **Environment** e **MotionControllers**</span><span class="sxs-lookup"><span data-stu-id="f3bf5-450">In the **Hierarchy** panel, delete **MixedRealityCamera**, **Environment** and **MotionControllers**</span></span>
* <span data-ttu-id="f3bf5-451">Dal **pannello progetto**, cercare e trascinare le seguenti prefabbricati nel pannello **gerarchia** :</span><span class="sxs-lookup"><span data-stu-id="f3bf5-451">From the **Project panel**, search and drag the following prefabs into the **Hierarchy** panel:</span></span>
    * <span data-ttu-id="f3bf5-452">Assets/AppPrefabs/input/prefabbricates/**MixedRealityCameraParent**</span><span class="sxs-lookup"><span data-stu-id="f3bf5-452">Assets/AppPrefabs/Input/Prefabs/**MixedRealityCameraParent**</span></span>
    * <span data-ttu-id="f3bf5-453">Assets/AppPrefabs/input/prefabbricates/**InputManager**</span><span class="sxs-lookup"><span data-stu-id="f3bf5-453">Assets/AppPrefabs/Input/Prefabs/**InputManager**</span></span>
    * <span data-ttu-id="f3bf5-454">Assets/AppPrefabs/input/prefabrics/Cursor/**DefaultCursor**</span><span class="sxs-lookup"><span data-stu-id="f3bf5-454">Assets/AppPrefabs/Input/Prefabs/Cursor/**DefaultCursor**</span></span>

    ![Padre della fotocamera della realtà mista](images/mr213-cameraparent-300px.png)

* <span data-ttu-id="f3bf5-456">Nel pannello **gerarchia** fare clic su **Gestione input** .</span><span class="sxs-lookup"><span data-stu-id="f3bf5-456">In the **Hierarchy** panel, click **Input Manager**</span></span>
* <span data-ttu-id="f3bf5-457">Nel pannello **Inspector** scorrere verso il basso fino alla sezione **semplice selettore puntatore singolo**</span><span class="sxs-lookup"><span data-stu-id="f3bf5-457">In the **Inspector** panel, scroll down to the **Simple Single Pointer Selector** section</span></span>
* <span data-ttu-id="f3bf5-458">Dal pannello **gerarchia** trascinare **DefaultCursor** in campo **cursore**</span><span class="sxs-lookup"><span data-stu-id="f3bf5-458">From the **Hierarchy** panel, drag **DefaultCursor** into **Cursor** field</span></span>

    ![Assegnazione di DefaultCursor](images/mr213-defaultcursor-500px.png)

* <span data-ttu-id="f3bf5-460">**Salva** la scena e fai clic sul pulsante **Riproduci** .</span><span class="sxs-lookup"><span data-stu-id="f3bf5-460">**Save** the scene and click the **play** button.</span></span> <span data-ttu-id="f3bf5-461">Sarà possibile usare levetta per ruotare verso sinistra o verso destra o Teleport.</span><span class="sxs-lookup"><span data-stu-id="f3bf5-461">You will be able to use the thumbstick to rotate left/right or teleport.</span></span>

## <a name="the-end"></a><span data-ttu-id="f3bf5-462">La fine</span><span class="sxs-lookup"><span data-stu-id="f3bf5-462">The end</span></span>

<span data-ttu-id="f3bf5-463">Questa è la fine di questa esercitazione.</span><span class="sxs-lookup"><span data-stu-id="f3bf5-463">And that's the end of this tutorial!</span></span> <span data-ttu-id="f3bf5-464">Sono stati appresi i concetti seguenti:</span><span class="sxs-lookup"><span data-stu-id="f3bf5-464">You learned:</span></span>

* <span data-ttu-id="f3bf5-465">Come usare i modelli di motion controller in modalità di gioco e runtime di Unity.</span><span class="sxs-lookup"><span data-stu-id="f3bf5-465">How to work with motion controller models in Unity's game mode and runtime.</span></span>
* <span data-ttu-id="f3bf5-466">Come usare tipi diversi di eventi dei pulsanti e le relative applicazioni.</span><span class="sxs-lookup"><span data-stu-id="f3bf5-466">How to use different types of button events and their applications.</span></span>
* <span data-ttu-id="f3bf5-467">Come sovrapporre gli elementi dell'interfaccia utente all'inizio del controller o personalizzarlo completamente.</span><span class="sxs-lookup"><span data-stu-id="f3bf5-467">How to overlay UI elements on top of the controller or fully customize it.</span></span>

<span data-ttu-id="f3bf5-468">A questo punto è possibile iniziare a creare un'esperienza immersiva con i controller di movimento.</span><span class="sxs-lookup"><span data-stu-id="f3bf5-468">You are now ready to start creating your own immersive experience with motion controllers!</span></span>

## <a name="completed-scenes"></a><span data-ttu-id="f3bf5-469">Scene completate</span><span class="sxs-lookup"><span data-stu-id="f3bf5-469">Completed scenes</span></span>

* <span data-ttu-id="f3bf5-470">Nel pannello del **progetto** di Unity fare clic sulla cartella **Scenes** .</span><span class="sxs-lookup"><span data-stu-id="f3bf5-470">In Unity's **Project** panel click on the **Scenes** folder.</span></span>
* <span data-ttu-id="f3bf5-471">Sono disponibili due scene Unity **MixedReality213** e **MixedReality213Advanced**.</span><span class="sxs-lookup"><span data-stu-id="f3bf5-471">You will find two Unity scenes **MixedReality213** and **MixedReality213Advanced**.</span></span>
    * <span data-ttu-id="f3bf5-472">**MixedReality213**: scena completata con pennello singolo</span><span class="sxs-lookup"><span data-stu-id="f3bf5-472">**MixedReality213**: Completed scene with single brush</span></span>
    * <span data-ttu-id="f3bf5-473">**MixedReality213Advanced**: sequenza completa con più pennelli con l'esempio di pressione del pulsante di selezione</span><span class="sxs-lookup"><span data-stu-id="f3bf5-473">**MixedReality213Advanced**: Completed scene with multiple brush with select button's press amount example</span></span>

## <a name="see-also"></a><span data-ttu-id="f3bf5-474">Vedere anche</span><span class="sxs-lookup"><span data-stu-id="f3bf5-474">See also</span></span>

* [<span data-ttu-id="f3bf5-475">File di progetto MR input 213</span><span class="sxs-lookup"><span data-stu-id="f3bf5-475">MR Input 213 project files</span></span>](https://github.com/Microsoft/MixedReality213)
* [<span data-ttu-id="f3bf5-476">Toolkit di realtà mista-scena di test del controller di movimento</span><span class="sxs-lookup"><span data-stu-id="f3bf5-476">Mixed Reality Toolkit - Motion Controller Test scene</span></span>](https://github.com/Microsoft/MixedRealityToolkit-Unity/tree/htk_release/Assets/HoloToolkit-Examples/Input/Scenes)
* [<span data-ttu-id="f3bf5-477">Toolkit per realtà mista-meccanismi di recupero</span><span class="sxs-lookup"><span data-stu-id="f3bf5-477">Mixed Reality Toolkit - Grab Mechanics</span></span>](https://github.com/Microsoft/MixedRealityToolkit-Unity/tree/htk_release/Assets/HoloToolkit-Examples/MotionControllers-GrabMechanics)
* [<span data-ttu-id="f3bf5-478">Linee guida per lo sviluppo di controller di movimento</span><span class="sxs-lookup"><span data-stu-id="f3bf5-478">Motion controller development guidelines</span></span>](../design/motion-controllers.md)