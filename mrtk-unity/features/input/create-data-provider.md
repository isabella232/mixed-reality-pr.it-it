...
I provider di dati con opzioni di configurazione aggiuntive, ad esempio [InputSimulationService](../input-simulation/input-simulation-service.md), devono creare un profilo e un controllo per consentire ai clienti di modificare il comportamento per soddisfare al meglio le esigenze dell'applicazione.
...
- [Strumento di mapping controller](../tools/controller-mapping-tool.md)
