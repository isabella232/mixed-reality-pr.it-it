...
> ![Piattaforme supportate per simulazione di input](../images/input-simulation/InputSimulationSupportedPlatforms.gif)
...
## <a name="viewport-buttons"></a>Pulsanti del riquadro di visualizzazione
...
* ![Icona della mano controllata](../images/input-simulation/MRTK_InputSimulation_HandIndicator_Controlled.png "Icona mano controllata") La mano viene rilevata e controllata dall'utente. Fare clic per nascondere la mano.
...
### <a name="controller-simulation-mode"></a>Modalità simulazione controller
