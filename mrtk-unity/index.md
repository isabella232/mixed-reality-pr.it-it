...
|---|---|
| OpenXR (Unity 2020.2 o versione più recente) | Microsoft HoloLens 2 <br> Visori VR di Windows Mixed Reality |
...
Se non si ha una nuova attività di sviluppo MRTK o realtà mista in Unity, è consigliabile installare ed esplorare l'applicazione di esempio MRTK Examples Hub nel dispositivo o nell'emulatore. 

> [!div class="nextstepaction"]
> [Scaricare l'app hub esempi MRTK](running-examples-hub.md)

Dopo aver ottenuto il blocco di ciò che realtà mista e MRTK ha da offrire, installare gli strumenti necessari e seguire la serie di esercitazioni HoloLens 2 principiante.
