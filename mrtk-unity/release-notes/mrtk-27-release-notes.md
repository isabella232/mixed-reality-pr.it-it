...
### <a name="support-for-controller-haptics-across-legacy-wmr-windows-xr-plugin-and-openxr"></a>Supporto per l'aptica del controller tra WMR legacy, plug-in Windows XR e OpenXR
