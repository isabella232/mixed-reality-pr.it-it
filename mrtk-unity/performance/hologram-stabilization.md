...
[Gli oggetti GameObject opachi](https://docs.unity3d.com/Manual/StandardShaderMaterialParameterRenderingMode.html) in Unity in genere scrivono automaticamente in profondità. Tuttavia, per impostazione & gli oggetti di testo trasparenti non scrivono in profondità per impostazione predefinita. Se si usa MRTK Standard Shader o Text Mesh Pro, è possibile risolvere questo problema facilmente.
